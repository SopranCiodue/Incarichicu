...
namespace IncarichiCUServer.Controllers
{
    public class StoricoCheckupController : ControllerBase
    {
        ...
        {
            string StoredProc = "exec Gestione_Incarichi_Ciodue.dbo.[SP_StoricoCheckup_GetIncarichi] @idsam =" + idsam;
        ...
        {
            string StoredProc = "exec Gestione_Incarichi_Ciodue.dbo.[SP_StoricoCheckup_GetAllegatiList] @keyord = '" + keyord +"', @haccp = "+ haccp + ",@PrendiAllegato = " + PrendiAllegato + ",@Tipologia = '" + Tipologia + "'";
        ...
        {
            string storedProc = $"exec Gestione_Incarichi_Ciodue.dbo.[SP_StoricoCheckup_GetAllegatiData] @keyord = '" + keyord + "', @haccp = "+ haccp +", @contatore = " + contatore + ", @rientro = " + rientro;
